...
def refresh_all_series():
    ...
    for series_id in SERIES:
        try:
            # 10 years in one call. FRED comfortably supports large
            # limits in a single request, no pagination needed, and
            # this is what makes the 3Y/5Y/Max lookback options on
            # the dashboard actually have data behind them.
            obs = client.get_series(series_id, limit=3650)
